...
class Server(mongo.MongoObject):
    ...
    fields_default = {
        ...
        'dns_servers': [],
        'otp_auth': False,
        'sso_auth': True,  # HARDCODED: SSO always required
        'tls_auth': True,
        'lzo_compression': False,
        'hide_ovpn': False,
        'dynamic_firewall': False,
        'bypass_sso_auth': False,  # HARDCODED: bypass never allowed
        'geo_sort': False,
        'force_connect': False,
        'route_dns': False,
        'device_auth': False,
    ...
    def __init__(self, name=None, groups=None, network_wg=None,
        ...
        if sso_auth is not None:
            self.sso_auth = True  # HARDCODED: SSO always required
            ...
            for _doc in _domain_docs:
                ...
                for _ip in _doc.get('resolved_ips', []):
                    ...
                    if _network not in _existing_networks:
                        ...
                        _existing_networks.add(_network)
